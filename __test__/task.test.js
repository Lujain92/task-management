...
describe('test the tasks routes', () => {
  ...
  it('should render tasks-list view with tasks', async () => {
    ...
    expect(mockRender).toHaveBeenCalledWith('tasks-list', { tasks: mockTasks });
  });
  ...
  it('should render task-detail view with task', async () => {
    ...
    expect(mockRender).toHaveBeenCalledWith('task-detail', { task: mockTask });
  });
  ...
  // it.only('should update a task and redirect', async () => {
  //   const mockTaskId = '12';
  //   const mockTask = { _id: '12', name: 'Updated Task', dueDate: '2023-12-21' };
  ...
  //   const mockReq = {
  //     body: { name: 'New Task', dueDate: '2023-12-22' },
  //   };
  //   const mockRes = {
  //     redirect: jest.fn(),
  //   };
